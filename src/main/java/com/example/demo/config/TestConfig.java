...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Local l1 = new Local(0L, "RUA CINCO", "VILA AZENHA", "NOVA ODESSA", "SÃO PAULO", 
				null, 40, 45464564654L);
		
		Local l2 = new Local(0L, "RUA HENRIQUE ", "CENTRO ", "AMERICANA ", "RIO DE JANEIRO",
		"só por colocar ", 78, 7897987987L);
		
		
		Local l3 = new Local(0L,"RUA oliveira", "jd mirandola", "suruguai", "oeste",
		null, 71, 78979567L);
